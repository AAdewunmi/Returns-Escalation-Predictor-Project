# path: apps/web/tests/test_case_detail_empty_states.py
"""
...
def test_case_detail_renders_empty_document_and_no_score_states(client):
    """
    Empty-state messaging should render cleanly when no documents or risk score exist.
    """
